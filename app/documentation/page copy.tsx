...
const PLAYER_URL = "https://player.vidstuck.xyz/embed";
...
<iframe src="${PLAYER_URL}/tv/1399/1/1"></iframe>`}</CodeBlock>
              ...
              <Endpoint
                title="Anime Shows"
                url={`${PLAYER_URL}/anime/anilist_id/episode`}
                description="Use the AniList ID and episode number."
              />

              <CodeBlock>{`<!-- One Piece — Episode 1 -->
<iframe src="${PLAYER_URL}/anime/21/1"></iframe>`}</CodeBlock>

              <Endpoint
                title="Anime Movies"
                url={`${PLAYER_URL}/anime/anilist_id`}
                description="Anime movies only require the AniList ID."
              />

              <CodeBlock>{`<!-- THE FIRST SLAM DUNK -->
<iframe src="${PLAYER_URL}/anime/145139"></iframe>`}</CodeBlock>

              <div className="rounded-xl border bg-muted/30 p-5">
                <p className="text-sm text-muted-foreground">
                  Anime shows automatically support subbed and dubbed versions
                  when available.
                </p>
              </div>
            </div>
...
></iframe>`}</CodeBlock>
              ...
              <div>
                <h3 className="mb-2 font-semibold">Netflix-style Overlay</h3>

                <CodeBlock>{`<iframe
  src="${PLAYER_URL}/movie/299534?overlay=true"
></iframe>`}</CodeBlock>
              </div>
              ...
              <div>
                ...
                <CodeBlock>{`<iframe
  src="${PLAYER_URL}/tv/1399/1/1?nextEpisode=true&autoplayNextEpisode=true&episodeSelector=true&overlay=true&color=8B5CF6"
></iframe>`}</CodeBlock>
              </div>
            </div>
          </Section>
  ...
  try {
    ...
    // Ignore invalid messages
          ...
          <Section
            ...
            description="The player uses TMDB IDs for movies and TV shows and AniList IDs for anime."
          >
            <div className="space-y-5">
              <div className="rounded-xl border p-5">
                <div className="mb-3 flex items-center gap-3">
              ...
              <div className="rounded-xl border p-5">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  Anime IDs can be found in the AniList URL or through the
                  AniList API.
                </p>
